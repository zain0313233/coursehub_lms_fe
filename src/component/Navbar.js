          ...
          <div className="flex items-center justify-between py-2 sm:py-3 text-xs sm:text-sm">
            <div className="flex items-center space-x-3 sm:space-x-6">
              <div className="flex items-center space-x-1 sm:space-x-2 hover:text-blue-300 transition-colors duration-200">
                ...
                <span className="font-medium hidden sm:inline">zain.ali.cs.dev@gmail.com</span>
            ...
            <div className="flex items-center">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 font-medium hidden sm:block">Learn & Grow</p>
                </div>
              </a>
            </div>
                  ...
                  <>
                    ...
                    {mobileDropdowns[item.name] && (
                      <div className="ml-4 mt-1 space-y-1">
                        <a href="#" className="block py-2 px-4 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors duration-200">
                          Submenu Item 1
                        </a>
                        <a href="#" className="block py-2 px-4 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors duration-200">
                          Submenu Item 2
