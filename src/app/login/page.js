            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Access thousands of courses, learn from expert instructors, and advance your career at your own pace.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 gap-4">
                <div className="flex items-center space-x-4 p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-gray-200">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">1000+ Courses</h4>
                    <p className="text-sm text-gray-600">Access diverse learning materials</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
              ...
              <div className="bg-gradient-to-br from-gray-700 via-gray-800 to-gray-900 p-8 text-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h1 className="text-2xl font-bold text-white mb-2">CourseHub LMS</h1>
                  <p className="text-gray-300 text-sm">Welcome back to your learning journey</p>
                </div>
              ...
              <div className="p-8 lg:p-10">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <a href="#" className="text-sm font-medium text-cyan-600 hover:text-cyan-500 transition-colors">
                      Forgot password?
                    </a>
                  </div>
                ...
                <div className="mt-8 text-center">
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span className="px-4 bg-white text-gray-500">New to CourseHub?</span>
                    </div>
                  </div>
                  <div className="mt-4">
                    <a
