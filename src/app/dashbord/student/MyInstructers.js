...
const MyInstructers = () => {
  return (
    <div>
                            <h3 className="text-xl font-semibold mb-4 text-gray-800 border-b border-gray-200 pb-2">My Instructors</h3>
                            <div className="flex gap-4">
                                <div className="flex-1 bg-gray-50 rounded-lg p-4 hover:shadow-md transition duration-200">
                                    <div className="flex flex-col items-center text-center">
                                        ...
                                        <div className="flex space-x-2">
                                            <button className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs hover:bg-blue-200 transition duration-200">Message</button>
                                            <button className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-xs hover:bg-gray-200 transition duration-200">Profile</button>
                                        </div>
                                    </div>
                                </div>
                                <div className="flex-1 bg-gray-50 rounded-lg p-4 hover:shadow-md transition duration-200">
                                    <div className="flex flex-col items-center text-center">
                                        ...
                                        <div className="flex space-x-2">
                                            <button className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs hover:bg-green-200 transition duration-200">Message</button>
                                            <button className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-xs hover:bg-gray-200 transition duration-200">Profile</button>
                                        </div>
                                    </div>
                                </div>
                                <div className="flex-1 bg-gray-50 rounded-lg p-4 hover:shadow-md transition duration-200">
                                    <div className="flex flex-col items-center text-center">
                                        ...
                                        <div className="flex space-x-2">
                                            <button className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-xs hover:bg-purple-200 transition duration-200">Message</button>
                                            <button className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-xs hover:bg-gray-200 transition duration-200">Profile</button>
                                        </div>
                                    </div>
                                </div>
