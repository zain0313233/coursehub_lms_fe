        ...
        <div className="bg-white shadow-md rounded-lg w-full h-auto">
          <div className="text-center mb-4 h-[200px] relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white z-10">
              <h1 className="text-4xl font-semibold text-gray-200 font-serif">Instructor Dashboard</h1>
              <p className="text-gray-100 font-serif">Welcome, {instructorData.name.split(' ')[1]}!</p>
            </div>
          </div>
