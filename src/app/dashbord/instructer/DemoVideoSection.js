  ...
  return (
    <div className="mb-8">
      ...
      {!hasVideo ? (
        ...
        <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
          ...
          <div className="p-6">
            ...
            <div className="md:flex block  items-center justify-between text-sm text-gray-500">
              ...
              <label className="bg-gray-600 hover:bg-gray-700 md:mt-0 mt-6 text-white px-4 py-2 rounded cursor-pointer inline-flex items-center text-sm transition-colors">
      ...
      <div className="mt-4 text-sm text-gray-500">
        <p>
          <strong>Tip:</strong> A good demo video should be 5-10 minutes long
          and showcase your teaching methodology, communication style, and
          subject matter expertise. Consider including a brief introduction and
          a sample lesson.
        </p>
      </div>
    </div>
